    ...
    <body>
        ...
        <div>
            ...
            <form action="<?= site_url('Pelanggan/controllerEditAkun/editAkun') ?>" method="post" enctype="multipart/form-data" class="editForm">
                <input type="text" name="Nama_Depan" placeholder="<?= session()->get('Nama_Depan') ?>"><br>
                <input type="text" name="Nama_Belakang" placeholder="<?= session()->get('Nama_Belakang') ?>"><br>
                <input type="date" name="Tanggal_Lahir" value="<?= session()->get('Tanggal_Lahir') ?? '' ?>"><br>
                <input type="text" name="Nomor_Telepon" placeholder="<?= session()->get('Nomor_Telepon') ?>"><br>
                <textarea name="Alamat" placeholder="<?= session()->get('Alamat') ?>" oninput="autoresize(this)"></textarea><br>
                <input type="text" name="Email" placeholder="<?= session()->get('Email') ?>"><br>
